...
class TecnicalAnalysis:
    ...
    def compute_oscillators(data):
        ...
        data['MA_Ratio_short'] = \
            ((talib.SMA(data['Close'], 5) - talib.SMA(data['Close'], 9)) / talib.SMA(data['Close'], 9))
        data['MA_Ratio'] = (
                    (talib.SMA(data['Close'], 9) - talib.SMA(data['Close'], 21)) / talib.SMA(data['Close'], 21))
        data['PR_MA_Ratio'] = ((data['Close'] - talib.SMA(data['Close'], 21)) / talib.SMA(data['Close'], 21))
